<template>
  <section class="organigrama-container">
    ...
    <div class="top-section">
      <h1>QUIENES SOMOS</h1>
      <p class="intro">
        SOLO, carpintería dedicada a fabricar muebles y trabajos en madera a medida, combinando experiencia y calidad. Nos enfocamos en detalles y materiales duraderos para entregar siempre resultados que superen tus expectativas. Transformamos la madera en piezas únicas para tu hogar o negocio.
       </p>
    </div>
