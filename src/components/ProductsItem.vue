...
//acrilicos
{
  ...
  categoria: 'DECORACIÓN',
  nombre: 'ACRILICOS',
  nota: 'Letreros con o sin Luz led en Acrilicos',
...
//MDF
{
  ...
  descripcion: 'Diseños MDF C/ Acrilico | Babys Events',
...
//vinil
{
  ...
  categoria: 'DECORACIÓN',
  nombre: 'VINIL',
  nota: 'Ideales para interiores, brindan una solución estética y económica sin iluminación.',
  descripcion: 'Letreros sin luz en acrilico o mdf y vinil',
...
//Lambrin
{
  ...
  categoria: 'DECORACIÓN',
  nombre: 'LAMBRÍN',
  nota: 'Letreros con o sin luz LED fabricados en lambrín de pvc, ideales para interiores modernos. Combinan estilo decorativo y funcionalidad para destacar marcas o mensajes.',
